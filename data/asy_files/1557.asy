...
arc a=arc(ellipse(C, 2, 0, 135), -45, 45);
...
markarc(format("%0g", degrees(a)), radius=11*markangleradius(), a);
...
arc ap=a/3;
draw(ap, 1mm+blue);
markarc(format("%0g", degrees(ap)), radius=11*markangleradius(), ap, blue);