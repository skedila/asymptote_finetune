...
markangle(sA, (line) t.AC, radius=7cm, StickIntervalMarker(1,1));
markangle((line) t.AB, mA, radius=7cm, StickIntervalMarker(1,1));
markangle(mA, sA, radius=7cm, StickIntervalMarker(2,2));