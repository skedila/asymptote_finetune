...
\def\ASYraw#1{#1}
\pdfpagewidth=300.128830bp
\ifx\pdfhorigin\undefined
\hoffset=-1in
\voffset=-1in
\pdfpageheight=251.534778bp
\else
\pdfhorigin=0bp
\pdfvorigin=0bp
\pdfpageheight=251.534778bp
...
\pagestyle{empty}
\textheight=269.534778bp
\textwidth=318.128830bp
\parindent=0pt
\oddsidemargin=0pt
...
\ASYalign(150.627156,126.239016)(-0.500000,-0.500000){\includegraphics[width=10cm, bb=60 60 235 205, clip=true]{dali.eps}}%
\end{document}
